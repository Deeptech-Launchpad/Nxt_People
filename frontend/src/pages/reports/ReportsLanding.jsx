...
const QUICK_LINKS_CATALOG = [
  {
    category: 'Payroll', icon: DollarSign, hidden: !PAYROLL_ADMIN_ENABLED,
    links: [
  ...
  return (
    <div className="bg-white rounded-xl shadow-sm border border-slate-200 min-h-[calc(100vh-12rem)]">
      <div className="px-6 py-5 border-b border-slate-100">
        ...
        <p className="text-[15px] text-slate-500 mt-1">{PAYROLL_ADMIN_ENABLED ? 'Attendance, payroll, shifts, and compliance reports.' : 'Attendance, leave, shifts, and compliance reports.'}</p>
      </div>
