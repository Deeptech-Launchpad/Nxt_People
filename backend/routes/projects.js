...
// ── POST create project ───────────────────────────────────────────────────────
router.post('/', authorize('admin', 'director', 'manager'), audit('CREATE', 'project'), async (req, res) => {
  try {
...
// ── PUT update project ────────────────────────────────────────────────────────
router.put('/:id', authorize('admin', 'director', 'manager'), audit('UPDATE', 'project'), async (req, res) => {
  try {
...
// ── POST add member ───────────────────────────────────────────────────────────
router.post('/:id/members', authorize('admin', 'director', 'manager'), async (req, res) => {
  try {
...
router.delete('/:id/members/:empId', authorize('admin', 'director', 'manager'), async (req, res) => {
  try {
    await pool.query(
...
// ── DELETE project ────────────────────────────────────────────────────────────
router.delete('/:id', authorize('admin', 'director'), audit('DELETE', 'project'), async (req, res) => {
  try {
